      ...
      {modalOpen && (
        <div className="jp-modal-backdrop" onMouseDown={(e) => e.target === e.currentTarget && setModalOpen(false)}>
          <form className="jp-modal" onSubmit={save}>
            ...
            <label className="jp-completion-check"><input type="checkbox" checked={form.isCompleted} onChange={(e) => setField('isCompleted', e.target.checked)} /><span>가게 정보를 모두 작성했습니다.</span></label>
